...
if (isset ( $user->email ) && isset ( $user->password )) {
	...
	try {
		...
		$query = $pdo->prepare ( "SELECT u.id_utilisateur as id, u.nom AS nom, u.prenom AS prenom, u.mail AS email, u.telephone AS telephone, u.nationalite AS nationalite, a.adresse AS adresse, v.libelle AS ville, v.code_postal AS code_postal, r.libelle AS region, t.libelle AS role
